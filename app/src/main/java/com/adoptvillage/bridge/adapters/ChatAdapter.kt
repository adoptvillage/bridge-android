                    ...
                    "TEXT" -> {
                        holder.itemView.apply {
                            ...
                            if (item.senderId!=currentUid){
                                if(item.senderId== DashboardActivity.dashboardAPIResponse.applications?.get(DashboardActivity.cardPositionClicked)?.donorId!! ){
                                    tvSenderRole.text="Donor"
                                }else if(item.senderId== DashboardActivity.dashboardAPIResponse.applications?.get(DashboardActivity.cardPositionClicked)?.moderatorId!! ){
                                    tvSenderRole.text="Moderator"
                                }else if(item.senderId== DashboardActivity.dashboardAPIResponse.applications?.get(DashboardActivity.cardPositionClicked)?.recipientId!! ) {
